...
export type AdminQuery = { __typename?: 'Query', me?: { __typename?: 'User', ownedJobs?: Array<{ __typename?: 'Job', id: string, title: string, location: string, type: Types.JobType, remote: boolean, salary: number, createdAt: Date, company: { __typename?: 'Company', id: string, name: string } }> | null } | null };
